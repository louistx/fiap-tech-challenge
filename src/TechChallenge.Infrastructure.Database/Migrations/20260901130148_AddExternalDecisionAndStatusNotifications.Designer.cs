...
namespace TechChallenge.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260901130148_AddExternalDecisionAndStatusNotifications")]
    partial class AddExternalDecisionAndStatusNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechChallenge.Domain.Entities.CategoriaProduto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TechChallenge.Domain.Entities.CategoriaServico", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TechChallenge.Domain.Entities.CategoriaVeiculo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TechChallenge.Domain.Entities.Estoque", b =>
                {
                    b.HasOne("TechChallenge.Domain.Entities.Produto", "Produto")
                        .WithOne("Estoque")
                        .HasForeignKey("TechChallenge.Domain.Entities.Estoque", "ProdutoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TechChallenge.Domain.Entities.Produto", b =>
                {
                    b.HasOne("TechChallenge.Domain.Entities.CategoriaProduto", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("TechChallenge.Domain.Entities.Servico", b =>
                {
                    b.HasOne("TechChallenge.Domain.Entities.CategoriaServico", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TechChallenge.Domain.Entities.Veiculo", b =>
                {
                    b.HasOne("TechChallenge.Domain.Entities.CategoriaVeiculo", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
